...
| `SKILL.md` | Phase 6 流程 | agent-browser（首選）→ claude-in-chrome（fallback） |
...
sources.tier3_browser[0]  →  sources[i] { tier: 3, fetch_method: "browser" }
